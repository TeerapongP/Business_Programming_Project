...
#nullable disable
    ...
    public class Pages_sweet_room_admin : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
            ...
            $('#delete_confirmation').dialog({
                ...
                buttons: {
                    Ok: function () {
                        ...
                        var action = 'delete'; //กำหนดตัวแปร action เป็น delete เพื่อ server (actions) จ");
            WriteLiteral(@"ะได้รู้ว่าต้องทำ delete
                        $.ajax({
                            url: ""./sweet_actions"",
                            method: ""POST"",
        ...
        function searchCustomers() {
            ...
            WriteLiteral(@" อ้างอิงถึง html element ไอดี เป็น data
